Feature: Register a vehicle
    ...
    Scenario: I can't register unexisting vehicle
        Given my fleet
        When I try to register this vehicle into my fleet
        Then I should be informed this vehicle is not found

    Scenario: I can't register vehicle in unexisting fleet
        Given a vehicle
        When I try to register this vehicle into my fleet
    ...
    Scenario: Can't create a fleet with an existing fleetId
        Given my fleet
        When I try to create same fleet
        Then I should be informed this fleet already exists
